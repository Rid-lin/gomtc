...
func Test_validateMac(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := v.GetSwithMac(tt.args.mac, tt.args.altMac, tt.args.hopeMac, tt.args.lastHopeMac); got != tt.want {
...
func Test_validateIP(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := v.ValidateIP(tt.args.ip, tt.args.altIp); got != tt.want {
...
func Test_isHexColon(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := v.IsHexColon(tt.args.s); got != tt.want {
...
func Test_isIP(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := v.IsIP(tt.args.inputStr); got != tt.want {
...
func Test_isMac(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := v.IsMac(tt.args.inputStr); got != tt.want {
...
func Test_isNumDot(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := v.IsNumDot(tt.args.s); got != tt.want {
...
func Test_isBlocked(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := v.InAddressList(tt.args.addressLists, tt.args.blockGroup); got != tt.want {
